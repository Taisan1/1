...
import { Copy, Search, ChevronDown, ChevronRight, FileText } from 'lucide-react';
import { Button } from '../ui/Button';
import { Card, CardHeader, CardTitle, CardContent } from '../ui/Card';

type ScriptType = 'collective9' | 'individual' | 'kindergarten';
...
const kindergartenMessages: ScriptMessage[] = [
  {
    id: 'kg-intro-1',
    title: 'Знакомство с ответственным родителем',
...
Менеджеру необходимо прикрепить обрезанный скрин списка класса`,
    category: '🚀 Первоначальные сообщения'
  },
  {
    id: 'kg-intro-2',
    title: 'Вопрос о детях, не берущих журнал',
    content: `Здравствуйте! 👋
...
Заранее спасибо! 💙`,
  ...
  {
    id: 'kg-info-collection',
    title: 'Начало сбора информации',
    content: `Здравствуйте!
...
Если будут вопросы - пишите 💙`,
  ...
  {
    id: 'kg-photo-groups',
    title: 'Разделение на группы для съемки',
    content: `Здравствуйте!
...
Группа 3: ФИ 7, ФИ 8 
И т.д.`,
    category: '📸 Организация съемки'
  },
  {
    id: 'kg-photo-schedule',
    title: 'Выбор даты и времени съемки',
    content: `Здравствуйте! 
...
Этого времени будет достаточно, чтобы фотограф успел сделать вам необходимое количество фотографий.`,
  ...
  {
    id: 'kg-final-decision',
    title: 'Окончательное решение по дате и локации',
    content: `Здравствуйте! 
...
Жду от Вас итоговое решение ✅`,
  ...
  {
    id: 'kg-group-shoot-garden',
    title: 'Общая съемка в саду - организация',
    content: `Здравствуйте! 👋
...
Как только станет известно, сообщите мне. Заранее спасибо! 💙`,
    category: '👥 Общая съемка'
  },
  {
    id: 'kg-group-shoot-details',
    title: 'Детали общей съемки в саду',
    content: `Здравствуйте!
...
⏳ Выбрать дату необходимо в течение 2 дней.. Заранее спасибо`,
  ...
  {
    id: 'kg-group-shoot-garden-confirm',
    title: 'Подтверждение общей съемки в саду',
    content: `Здравствуйте!
...
Пожалуйста, проконтролируйте процесс подготовки. Заранее спасибо!💙`,
  ...
  {
    id: 'kg-group-shoot-studio-details',
    title: 'Детали общей съемки в студии',
    content: `Здравствуйте! 
...
Пожалуйста, проконтролируйте процесс подготовки. Заранее спасибо!`,
  ...
  {
    id: 'kg-reminder-garden',
    title: 'Напоминание о съемке в саду (завтра)',
    content: `Здравствуйте! 
...
4) Необходимы будут: 2 парты, стулья около 10 штук ✅`,
  ...
  {
    id: 'kg-reminder-studio',
    title: 'Напоминание о съемке в студии (завтра)',
    content: `Здравствуйте!
...
В группах необходимо указать всех выпускников. Неберущих помечать - Имя Фамилия (не берёт). Максимальное количество человек в группе - 5. Максимальное количество групп - см. во втором столбце разделения на группы.`,
  ...
  {
    id: 'kg-check-list',
    title: 'Проверка списка перед съемкой',
    content: `Здравствуйте!
...
Напоминание №1 и №2`,
  ...
  {
    id: 'kg-reminder-1',
    title: 'Напоминание №1 о сборе информации',
    content: `Здравствуйте!
...
Скрин необходимо делать так, чтобы не было видно ничего лишнего.`,
  ...
  {
    id: 'kg-reminder-2',
    title: 'Напоминание №2 о сборе информации (завтра дедлайн)',
    content: `Здравствуйте!
Это сообщение нужно переслать остальным родителям.
...
3.	Если вы оставляете после себя МУСОР (фантики, бутылки и тому подобное), то его нужно будет УБРАТЬ, чтобы студия выглядела так, какой она была перед первой группой.`,
    category: '💡 Лайфхаки для съемки'
  },
  {
    id: 'kg-lifehacks-garden',
    title: 'Лайфхаки для съемки в саду',
    content: `Здравствуйте!
Просьба: переслать это сообщение остальным родителям.
...
2.	Взять с собой реквизит. Примеры: тёмные очки, головные уборы или атрибуты хобби ребёнка (гитара, мяч и т.д.🕶️🧢🎸)`,
  ...
  {
    id: 'kg-shoot-reminder',
    title: 'Напоминание о дне съемки',
    content: `Здравствуйте!
Это сообщение необходимо переслать остальным родителям.
...
4) 📍Обращаю внимание на то, что опрос необходимо заполнить за один раз, если выйти на половине написанного, то ничего не сохранится и придётся писать заново. Перед закрытием опроса ОБЯЗАТЕЛЬНО нажать кнопку "Отправить", чтобы всё написанное у нас сохранилось.`,
    category: '🖼️ Работа с фотографиями'
  },
  {
    id: 'kg-missed-shoot',
    title: 'Сообщение о пропущенной съемке',
    content: `Здравствуйте!
(…) не было на фотосессии с группой. Пусть родители не переживают, мы проведем дополнительную съёмку и сделаем недостающие фотографии. Дату и локацию сообщим позже.`,
    category: '📷 Дополнительные съемки'
  },
  {
    id: 'kg-photo-reminder',
...
📍Чтобы скачать в хорошем качестве с диска из ваших папок: около списка фоток нажимать на три точки, дальше нажать отправить копию, затем на сохранить изображение.`,
  ...
  {
    id: 'kg-print-offer-1',
    title: 'Предложение дополнительной печати (вариант 1)',
...
(фото номер 1561 - формат А6).`,
  ...
  {
    id: 'kg-print-offer-2',
    title: 'Предложение дополнительной печати (вариант 2)',
    content: `Здравствуйте! Просьба передать это родителям. 
...
Ожидаю от Вас финального сообщения с информацией завтра до 20:00🤗`,
  ...
  {
    id: 'kg-group-photos-select-1',
    title: 'Выбор общих фотографий (с воспитателями)',
    content: `Здравствуйте!
...
2) 📍Кол-во фоток: 3 индивидуальные (одна из которых - на обложку). Старайтесь выбирать фотографии непохожие друг на друга, чтобы у Вас в журнале было разнообразие.`,
  ...
  {
    id: 'kg-additional-shoot-2',
    title: 'Дополнительная съемка - не понравились фотки',
    content: `Перешлите, пожалуйста, это сообщение родителям (Имя Фамилия выпускника)
🤩 Вот исходники с  дополнительной съёмки. Фотки сырые, с убранным цветом и светом в минимум. Необработанные, не выровненные и тд.
❗️НЕ ВЫКЛАДЫВАЙТЕ ИХ НИКУДА.
(ссылка на исходники)
...
На обложку фото с первой фотосессии IMG_4321.jpg`,
  ...
  {
    id: 'kg-group-photos-ready',
    title: 'Готовые общие фотографии',
...
(прикрепить ссылку на папку фото  воспитателя)`,
  ...
  {
    id: 'kg-additional-photos-ready',
    title: 'Готовые дополнительные фотографии',
...
📍Чтобы скачать в хорошем качестве с диска из ваших папок: около списка фоток нажимать на три точки, дальше нажать отправить копию, затем на сохранить изображение.
 💙`,
  ...
  {
    id: 'kg-journals-check',
    title: 'Проверка электронных версий журналов',
    content: `Здравствуйте! 👋
...
Пожалуйста, отпишите мне, как только разошлёте это сообщение родителям, заранее спасибо!!! 💙`,
    category: '✅ Проверка журналов'
  },
  {
    id: 'kg-journals-reminder',
    title: 'Напоминание о правках журналов',
    content: `Здравствуйте! 👋
...
ДЛЯ МЕНЕДЖЕРА: этот скрипт необходимо отправить после 20:00`,
  ...
  {
    id: 'kg-corrections-final',
    title: 'Итоги по правкам журналов',
...
// Заглушки для других типов скриптов
const collective9Messages: ScriptMessage[] = [
  {
    id: 'c9-placeholder',
    title: 'Скрипт в разработке',
    content: 'Скрипт для коллективного 9 класса находится в разработке.',
    category: '🚧 В разработке'
  }
];

const individualMessages: ScriptMessage[] = [
  {
    id: 'ind-placeholder',
    title: 'Скрипт в разработке',
    content: 'Скрипт для индивидуальных проектов находится в разработке.',
    category: '🚧 В разработке'
  }
];

export default function Script() {
  const [activeTab, setActiveTab] = useState<ScriptType>('kindergarten');
  ...
  const getMessages = () => {
    switch (activeTab) {
      case 'collective9':
        return collective9Messages;
      case 'individual':
        return individualMessages;
      case 'kindergarten':
        return kindergartenMessages;
      default:
        return kindergartenMessages;
    }
  };
  ...
  const groupedMessages = filteredMessages.reduce((acc, message) => {
    ...
    return acc;
  }, {} as Record<string, ScriptMessage[]>);
  ...
  const getTabTitle = (tab: ScriptType) => {
    switch (tab) {
      case 'collective9':
        return 'Коллективный 9';
      case 'individual':
  ...
  return (
    <div className="p-4 md:p-6 space-y-4 md:space-y-6">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Скрипты для работы</h1>
        <p className="text-sm md:text-base text-gray-600 mt-1">
          Готовые сообщения для общения с клиентами
        </p>
      </div>
      ...
      <div className="border-b border-gray-200">
        <nav className="-mb-px flex space-x-8">
          {(['kindergarten', 'collective9', 'individual'] as ScriptType[]).map((tab) => (
            <button
              key={tab}
          ...
          <Card key={category}>
            ...
            >
              <CardTitle className="flex items-center justify-between">
                <span className="text-base md:text-lg">{category}</span>
                <div className="flex items-center space-x-2">
                  <span className="text-sm text-gray-500">({categoryMessages.length})</span>
                ...
                {categoryMessages.map((message) => (
                  <div key={message.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                    <div className="flex items-start justify-between mb-3">
                      <h3 className="font-semibold text-gray-900 text-sm md:text-base">{message.title}</h3>
                      <Button
                        size="sm"
                        variant="outline"
                    ...
                    <div className="bg-gray-50 rounded-lg p-3 max-h-64 overflow-y-auto">
                      <pre className="text-xs md:text-sm text-gray-700 whitespace-pre-wrap font-sans leading-relaxed">
                        {message.content}
                      </pre>
                    </div>
                  </div>
        ...
        <Card className="text-center py-12">
          <CardContent>
            ...
            <p className="text-gray-600">
              Попробуйте изменить поисковый запрос или выберите другую вкладку
            </p>
          </CardContent>
        </Card>
      )}
